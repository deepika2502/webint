...
function reset_waste() {
  ...
  document.getElementById("disabledRange").value =
    localStorage.getItem("waste_slider") || 50;
...
function reset_travel() {
  ...
  document.getElementById("disabledRange").value =
    localStorage.getItem("travel_slider") || 50;
  slider_travel = localStorage.getItem("travel_slider") || 50;
...
function reset_electricity() {
  ...
  document.getElementById("disabledRange").value =
    localStorage.getItem("electricity_slider") || 50;
  slider_electricity = localStorage.getItem("electricity_slider") || 50;
...
function recycle(id) {
  ...
  if (isNaN(x) || isNaN(y)) {
    ...
    document.getElementById("clothes").value = "";
    document.getElementById("aluminium").value = "";
    localStorage.setItem("waste_slider", totalW);
  }
}
